...
###                                                                                                                                    ###
##                                                                                                                                      ##
#                                                   AMP - download/process MSBB - U133B - PIEPLINE V02                                   #
##                                                                                                                                      ##
###                                                                                                                                    ###
####                                                                                                                                  ####
##########################################################################################################################################
...
## EXPRESSION CHIP - HG-U133B
## 997 samples - 570 samples belonging to regions used
#####
...
data_dir_U133B="/media/hamel/Workspace/Projects/Brain_expression/1.Data/AD/AMP_MSBB/Raw_Data/AffymetrixHG-U133B/"

work_dir="/media/hamel/1TB/Projects/Brain_expression/1.Data/1.Re-process_with_new_pipeline/AD/AMP_MSBB/Pre-Processing/AffymetrixHG-U133B/Pre-Processing"
...
head(Frontal_Pole_control_exprs_M)
...
# check dataframe - all should be 2712
...
head(Precentral_Gyrus_control_exprs_good_probes)[1:2]
...
head(Temporal_Pole_control_exprs_good_probes)[1:3]
...
Gene_symbols_probes <- mappedkeys(hgu133bSYMBOL)

# Convert to a list
Gene_symbols <- as.data.frame(hgu133bSYMBOL[Gene_symbols_probes])
...
plot_gender_specific_genes(Dorsolateral_Prefrontal_Cortex_case_exprs, gender_comparison[1], gene_list, 0.9, "Dorsolateral_Prefrontal_Cortex_case_exprs_gender_specific_genes")
plot_gender_specific_genes(Dorsolateral_Prefrontal_Cortex_case_exprs, gender_comparison[2], gene_list, 0.9, "Dorsolateral_Prefrontal_Cortex_case_exprs_gender_specific_genes")
plot_gender_specific_genes(Frontal_Pole_case_exprs, gender_comparison[1], gene_list, 0.9, "Frontal_Pole_case_exprs_gender_specific_genes")
plot_gender_specific_genes(Frontal_Pole_case_exprs, gender_comparison[2], gene_list, 0.9, "Frontal_Pole_case_exprs_gender_specific_genes")
plot_gender_specific_genes(Hippocampus_case_exprs, gender_comparison[1], gene_list, 0.9, "Hippocampus_case_exprs_gender_specific_genes")
...
plot_gender_specific_genes(Inferior_Temporal_Gyrus_case_exprs, gender_comparison[1], gene_list, 0.9, "Inferior_Temporal_Gyrus_case_exprs_gender_specific_genes")
plot_gender_specific_genes(Inferior_Temporal_Gyrus_case_exprs, gender_comparison[2], gene_list, 0.9, "Inferior_Temporal_Gyrus_case_exprs_gender_specific_genes")
plot_gender_specific_genes(Middle_Temporal_Gyrus_case_exprs, gender_comparison[1], gene_list, 0.9, "Middle_Temporal_Gyrus_case_exprs_gender_specific_genes")
plot_gender_specific_genes(Middle_Temporal_Gyrus_case_exprs, gender_comparison[2], gene_list, 0.9, "Middle_Temporal_Gyrus_case_exprs_gender_specific_genes")
plot_gender_specific_genes(Parahippocampal_Gyrus_case_exprs, gender_comparison[1], gene_list, 0.9, "Parahippocampal_Gyrus_case_exprs_gender_specific_genes")
...
plot_gender_specific_genes(Superior_Parietal_Lobule_case_exprs, gender_comparison[1], gene_list, 0.9, "Superior_Parietal_Lobule_case_exprs_gender_specific_genes")
plot_gender_specific_genes(Superior_Parietal_Lobule_case_exprs, gender_comparison[2], gene_list, 0.9, "Superior_Parietal_Lobule_case_exprs_gender_specific_genes")
dev.off()
...
legend('topright', unique(Diagnosis_pca$Diagnosis), fill=unique(Diagnosis_pca_color))
...
legend('topright', as.character(unique(brain_region_pca)), fill=unique(brain_region_pca_color), cex = 0.5)
...
Superior_Parietal_Lobule_exprs_good_probes_sva_adjusted<-adjust_for_sva(Superior_Parietal_Lobule_exprs_good_probes)
...
Hippocampus_exprs_good_probes_sva_adjusted<-adjust_for_sva(Hippocampus_exprs_good_probes)
Inferior_Temporal_Gyrus_exprs_good_probes_sva_adjusted<-adjust_for_sva(Inferior_Temporal_Gyrus_exprs_good_probes)
Middle_Temporal_Gyrus_exprs_good_probes_sva_adjusted<-adjust_for_sva(Middle_Temporal_Gyrus_exprs_good_probes)
Superior_Temporal_Gyrus_exprs_good_probes_sva_adjusted<-adjust_for_sva(Superior_Temporal_Gyrus_exprs_good_probes)

# 2nd round sva
Hippocampus_exprs_good_probes_sva_adjusted<-adjust_for_sva(Hippocampus_exprs_good_probes_sva_adjusted)

# changed name for non sva adjusted data
...
Hippocampus_exprs_good_probes_sva_adjusted_case_QC<-run_sample_network_plot(Hippocampus_exprs_good_probes_sva_adjusted_case, -3)
...
Middle_Temporal_Gyrus_exprs_good_probes_sva_adjusted_case_QC<-run_sample_network_plot(Middle_Temporal_Gyrus_exprs_good_probes_sva_adjusted_case, -3)
Superior_Temporal_Gyrus_exprs_good_probes_sva_adjusted_case_QC<-run_sample_network_plot(Superior_Temporal_Gyrus_exprs_good_probes_sva_adjusted_case, -3)
...
run_sample_network_plot(Hippocampus_exprs_good_probes_sva_adjusted_case, -3)
dev.off()
...
run_sample_network_plot(Middle_Temporal_Gyrus_exprs_good_probes_sva_adjusted_case, -3)
dev.off()

pdf("Superior_Temporal_Gyrus_sample_network_analysis_cases.pdf")
run_sample_network_plot(Superior_Temporal_Gyrus_exprs_good_probes_sva_adjusted_case, -3)
dev.off()
...
legend('bottomright', unique(Diagnosis_pca_QCd$Diagnosis), fill=unique(Diagnosis_pca_color_QCd))
...
legend('topright', as.character(unique(brain_region_pca_QCd)), fill=unique(brain_region_pca_color_QCd), cex=0.5)
...
plot(pca$rotation[,1:2], main=" PCA plot coloured by Disease Status",col="black", pch=21,bg=Diagnosis_pca_color)
legend('topleft', unique(Diagnosis_pca$Diagnosis), fill=unique(Diagnosis_pca_color))
plot(pca_QCd$rotation[,1:2], main=" PCA plot coloured by Disease Status after QC",col="black", pch=21,bg=Diagnosis_pca_color_QCd)
legend('topleft', unique(Diagnosis_pca_QCd$Diagnosis), fill=unique(Diagnosis_pca_color_QCd))
#pca plot by brain region
plot(pca$rotation[,1:2], main=" PCA plot coloured by Brain Region",col="black", pch=21,bg=brain_region_pca_color)
legend('topleft', as.character(unique(brain_region_pca)), fill=unique(brain_region_pca_color), cex = 0.5)
plot(pca_QCd$rotation[,1:2], main=" PCA plot coloured by Brain Region after QC",col="black", pch=21,bg=brain_region_pca_color_QCd)
legend('topleft', as.character(unique(brain_region_pca_QCd)), fill=unique(brain_region_pca_color_QCd), cex=0.5)
dev.off()
...
# Get the probe identifiers that are mapped to an ENTREZ Gene ID using hgu133b.db
mapped_probes <- mappedkeys(hgu133bENTREZID)

# Convert to a list
hgu133b.db_mapping <- as.data.frame(hgu133bENTREZID[mapped_probes])
# arrange order of column by entrezgene probe_id
hgu133b.db_mapping<-hgu133b.db_mapping[c(2,1)]
colnames(hgu133b.db_mapping)[1]<-"entrezgene"

head(hgu133b.db_mapping)
dim(hgu133b.db_mapping)

#check any duplicated probe IDs
anyDuplicated(hgu133b.db_mapping$probe_id)

#check any dupliacted entrezgene IDs
anyDuplicated(hgu133b.db_mapping$entrezgene)
...
brain_data_QCd_entrez_id<-convert_probe_id_to_entrez_id(brain_data_QCd[3:dim(brain_data_QCd)[2]], hgu133b.db_mapping)
dim(brain_data_QCd)
...
write.table(brain_data_QCd_entrez_id_unique_pheno, file="AMP_MSBB_U133B_pre-processed_data2.txt", sep="\t")

##### SAVE PHENOTYPE DATAFRAME #####

setwd(clean_data_dir)

write.table(phenotype, file="AMP_MSBB_U133B_phenotype_data2.txt", sep="\t")
...
write(unique(sort(c(Frontal_Pole_control_exprs_F_expressed_probes_list, Frontal_Pole_control_exprs_M_expressed_probes_list))), file="AMP_MSBB_U133B_Frontal_Pole.txt")
write(unique(sort(c(Precentral_Gyrus_control_exprs_F_expressed_probes_list, Precentral_Gyrus_control_exprs_M_expressed_probes_list))), file="AMP_MSBB_U133B_Precentral_Gyrus.txt")
write(unique(sort(c(Inferior_Frontal_Gyrus_control_exprs_F_expressed_probes_list, Inferior_Frontal_Gyrus_control_exprs_M_expressed_probes_list))), file="AMP_MSBB_U133B_Inferior_Frontal_Gyrus.txt")
write(unique(sort(c(Dorsolateral_Prefrontal_Cortex_control_exprs_F_expressed_probes_list, Dorsolateral_Prefrontal_Cortex_control_exprs_M_expressed_probes_list))), file="AMP_MSBB_U133B_Dorsolateral_Prefrontal_Cortex.txt")
write(unique(sort(c(Superior_Parietal_Lobule_control_exprs_F_expressed_probes_list, Superior_Parietal_Lobule_control_exprs_M_expressed_probes_list))), file="AMP_MSBB_U133B_Superior_Parietal_Lobule.txt")
write(unique(sort(c(Prefrontal_Cortex_control_exprs_F_expressed_probes_list, Prefrontal_Cortex_control_exprs_M_expressed_probes_list))), file="AMP_MSBB_U133B_Prefrontal_Cortex.txt")
write(unique(sort(c(Parahippocampal_Gyrus_control_exprs_F_expressed_probes_list, Parahippocampal_Gyrus_control_exprs_M_expressed_probes_list))), file="AMP_MSBB_U133B_Parahippocampal_Gyrus.txt")
write(unique(sort(c(Hippocampus_control_exprs_F_expressed_probes_list, Hippocampus_control_exprs_M_expressed_probes_list))), file="AMP_MSBB_U133B_Hippocampus.txt")
write(unique(sort(c(Inferior_Temporal_Gyrus_control_exprs_F_expressed_probes_list, Inferior_Temporal_Gyrus_control_exprs_M_expressed_probes_list))), file="AMP_MSBB_U133B_Inferior_Temporal_Gyrus.txt")
write(unique(sort(c(Middle_Temporal_Gyrus_control_exprs_F_expressed_probes_list, Middle_Temporal_Gyrus_control_exprs_M_expressed_probes_list))), file="AMP_MSBB_U133B_Middle_Temporal_Gyrus.txt")
write(unique(sort(c(Superior_Temporal_Gyrus_control_exprs_F_expressed_probes_list, Superior_Temporal_Gyrus_control_exprs_M_expressed_probes_list))), file="AMP_MSBB_U133B_Superior_Temporal_Gyrus.txt")
write(unique(sort(c(Temporal_Pole_control_exprs_F_expressed_probes_list, Temporal_Pole_control_exprs_M_expressed_probes_list))), file="AMP_MSBB_U133B_Temporal_Pole.txt")
...
save.image(file="AMP_MSBB_U133B_data_processing2.Rdata")
