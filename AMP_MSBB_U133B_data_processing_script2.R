...
write(Frontal_Pole_control_expressed_probes_list, file="AMP_MSBB_U133B_Frontal_Pole.txt") 
write(Precentral_Gyrus_control_expressed_probes_list, file="AMP_MSBB_U133B_Precentral_Gyrus.txt") 
write(Inferior_Frontal_Gyrus_control_expressed_probes_list, file="AMP_MSBB_U133B_Inferior_Frontal_Gyrus.txt") 
write(Dorsolateral_Prefrontal_Cortex_control_expressed_probes_list, file="AMP_MSBB_U133B_Dorsolateral_Prefrontal_Cortex.txt") 
write(Superior_Parietal_Lobule_control_expressed_probes_list, file="AMP_MSBB_U133B_Superior_Parietal_Lobule.txt") 
write(Prefrontal_Cortex_control_expressed_probes_list, file="AMP_MSBB_U133B_Prefrontal_Cortex.txt") 
write(Parahippocampal_Gyrus_control_expressed_probes_list, file="AMP_MSBB_U133B_Parahippocampal_Gyrus.txt") 
write(Hippocampus_control_expressed_probes_list, file="AMP_MSBB_U133B_Hippocampus.txt") 
write(Inferior_Temporal_Gyrus_control_expressed_probes_list, file="AMP_MSBB_U133B_Inferior_Temporal_Gyrus.txt") 
write(Middle_Temporal_Gyrus_control_expressed_probes_list, file="AMP_MSBB_U133B_Middle_Temporal_Gyrus.txt") 
write(Superior_Temporal_Gyrus_control_expressed_probes_list, file="AMP_MSBB_U133B_Superior_Temporal_Gyrus.txt") 
write(Temporal_Pole_control_expressed_probes_list, file="AMP_MSBB_U133B_Temporal_Pole.txt") 
