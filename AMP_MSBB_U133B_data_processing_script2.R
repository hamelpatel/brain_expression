...
work_dir="/media/hamel/1TB/Projects/Brain_expression/1.Data/2.Re-process_with_new_pipeline/AD/AMP_MSBB/Pre-Processing/AffymetrixHG_U133B/Pre-Processing"
...
# check dataframe - all should be 2169
...
Hippocampus_exprs_good_probes_sva_adjusted_case_QC<-run_sample_network_plot(Hippocampus_exprs_good_probes_sva_adjusted_case, -2.5)
...
run_sample_network_plot(Hippocampus_exprs_good_probes_sva_adjusted_case, -2.5)
dev.off()
...
legend('topright', unique(Diagnosis_pca$Diagnosis), fill=unique(Diagnosis_pca_color))
plot(pca_QCd$rotation[,1:2], main=" PCA plot coloured by Disease Status after QC",col="black", pch=21,bg=Diagnosis_pca_color_QCd)
legend('topright', unique(Diagnosis_pca_QCd$Diagnosis), fill=unique(Diagnosis_pca_color_QCd))
...
brain_data_QCd_entrez_id<-convert_probe_id_to_entrez_id(brain_data_QCd[2:dim(brain_data_QCd)[2]], hgu133b.db_mapping)
dim(brain_data_QCd)
