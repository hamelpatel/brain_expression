...
work_dir="/media/hamel/1TB/Projects/Brain_expression/1.Data/2.Re-process_with_new_pipeline/AD/E-GEOD-48350/Pre-Processing"
...
Postcentral_Gyrus_case_expressed_probes_list<-extract_good_probe_list(Postcentral_Gyrus_case_exprs, 0.9, 0.8)
head(Postcentral_Gyrus_case_expressed_probes_list)
length(Postcentral_Gyrus_case_expressed_probes_list)
nrow(Postcentral_Gyrus_case_exprs)
...
Postcentral_Gyrus_control_expressed_probes_list<-extract_good_probe_list(Postcentral_Gyrus_control_exprs, 0.9, 0.8)
head(Postcentral_Gyrus_control_expressed_probes_list)
length(Postcentral_Gyrus_control_expressed_probes_list)
nrow(Postcentral_Gyrus_control_exprs)
...
good_probe_list<-unique(sort(c(Entorhinal_Cortex_case_expressed_probes_list,
                               ...
                               Postcentral_Gyrus_control_expressed_probes_list,
...
# check dataframe - all should be 5168
