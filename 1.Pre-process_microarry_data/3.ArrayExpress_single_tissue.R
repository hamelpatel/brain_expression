...
###                                                                                                                                    ###
##                                                                                                                                      ##
#                                              E-GEOD-5388 PROCESSING                                                                   #
##                                                                                                                                      ##
###                                                                                                                                    ###
####                                                                                                                                  ####
##########################################################################################################################################

# QC PIPELINE VERSION: 2.2 single dataset, single tissue
# DATE: 08/02/2017
# ARRAY EXPRESS NUMBER: E-GEOD-5388
...
work_dir="/media/hamel/Workspace/Dropbox/Projects/Brain_expression/1.Data/1.Re-process_with_new_pipeline/NON-AD-NEUROLOGICAL/Bipolar_Disorder/E-GEOD-5388"
...
#raw data only
data_raw=getAE("E-GEOD-5388", type = "raw")

#processed data only
#data_raw=getAE("E-GEOD-5388", type = "processed")

#all data
#data_raw=getAE("E-GEOD-5388", type = "full")
...
Age<-phenotype_data[1]
colnames(Age)<-"Age"

Diagnosis<-phenotype_data[3]
...
Diagnosis[grep("bipolar disorder", Diagnosis[,1]),]<-"case"
table(Diagnosis)
...
#expression_data_normalised<-rsn(log2(exprs(expression_data)))
